...
public class TorderItem implements java.io.Serializable {
	...
	private String productPromotio;
	...
	public TorderItem(String orderId, int productId, int quantity,
		...
		this.attributes = attributes;
		this.isGift = isGift;
		this.productPromotio = productPromotio;
	}
	...
	public String getProductPromotio() {
		return this.productPromotio;
	}

	public void setProductPromotio(String productPromotio) {
		this.productPromotio = productPromotio;
	}
